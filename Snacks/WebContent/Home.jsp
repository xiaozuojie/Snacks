...
<div class="index_style clearfix">
  <div id="allSortOuterbox">
    ...
    <div class="hd_allsort_out_box_new">
	 ...
	 <ul class="Menu_list">	
	    <li class="name">
		<div class="Menu_name"><a href="product_list.html" >坚果炒货</a> <span>&lt;</span></div>
		<div class="link_name">
...
<!--幻灯片样式-->
   	<div id="slideBox" class="slideBox">
			...
			<div class="bd">
				<ul>
					<li><a href="Product_Detailed.html" target="_blank"><div style="background:url(AD/ad-1.jpg) no-repeat rgb(255, 227, 130); background-position:center; width:53%; height:460px;margin-left: 550px;"></div></a></li>
					<li><a href="Product_Detailed.html" target="_blank"><div style="background:url(AD/ad-2.jpg) no-repeat rgb(245, 143, 120); background-position:center ; width:53%; height:460px;margin-left: 550px;"></div></a></li>
					<li><a href="Product_Detailed.html" target="_blank"><div style="background:url(AD/ad-3.jpg) no-repeat rgb(199, 215, 161); background-position:center; width:53%; height:460px;margin-left: 550px;"></div></a></li>
                    <li><a href="Product_Detailed.html" target="_blank"><div style="background:url(AD/ad-7.jpg) no-repeat #f7ddea; background-position:center; width:53%; height:460px;margin-left: 550px;"></div></a></li>
                    <li><a href="Product_Detailed.html" target="_blank"><div style="background:url(AD/ad-6.jpg) no-repeat #F6F6F6; background-position:center; width:53%; height:460px;margin-left: 550px;"></div></a></li>
				</ul>
			</div>
